...
This project emphasizes correctness and transparency by separating analytical logic from conversational layers, avoiding black-box AI for numerical decisions. Built as a modular, extensible system, SpendWise AI demonstrates practical applications of data analytics, recommendation logic, and conversational interfaces for real-world personal finance use cases.

Tech Stack: Python, Pandas, NumPy, Matplotlib
Core Techniques: Aggregation pipelines, anomaly detection (Z-score, MoM change), rule-based recommendation, tool-driven chatbot design
